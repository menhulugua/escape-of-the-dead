  ...
  render() {
    ...
    return (
      <div>
        ...
        <Link to="/instruction">Game Instruction</Link>
        <div>
          <p>Assign Dice</p>
...
export default connect(mapStateToProps, { spawnZombie, phaseProgress, damageBarricade, assignDice, clearDice, playAction, clearAction, killZombie, fixBarricade, fixGarage, killIncrease, canZombieSpawn, resetGame })(Game);
