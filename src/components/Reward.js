...
const Reward = props => {
    return (
      <div>
        ...
        <input type="radio" name="reward" id="reward1" value="1" /> <label htmlFor="reward1">Destroy all zombies</label><br/>
        ...
        <button disabled={props.phase !== 5 || props.zombieKilled < REWARD_KILL}>Use Reward</button>
      </div>
    );
}
